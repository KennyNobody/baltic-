  ...
  <div class="player">
    <transition name="player__fade">
      <div class="playlist" v-if="open">
        <div class="playlist__left">
          <p class="playlist__title">Подкасты</p>
          <article
            class="p-podcast"
          ...
          >
            <div
              ...
              v-bind:style="{ 'background-image': 'url(' + item.thumb + ')' }"
            >
              <div class="p-podcast__play" v-on:click="playThis(item)">
    ...
    <div class="player__left">
      ...
      <div class="player__info">
        <div class="player__radio live">
          <div v-if="player.live == true" class="live__radio">Прямой эфир</div>
          <div v-else>
            <div class="live__podcast">Подкаст</div>
    ...
    <div class="player__thumb">
      ...
      <template v-else>
        ...
        >
          <path
            d="M40.7969 0.494375C38.8817 0.168992 36.9427 0.00362902 35 0C15.6625 0 0 15.6625 0 35C0 42.4244 2.33406 49.2844 6.25625 54.9741C8.6625 51.4391 14.2122 49 20.6456 49C25.0644 49 29.0609 50.1659 31.9244 52.0406L40.7969 0.494375ZM59.395 9.93344C65.4391 23.2991 60.1366 30.4391 60.1366 30.4391C56.035 18.1016 44.1569 16.2991 44.1569 16.2991C44.1569 16.2991 36.3431 58.4041 36.3431 58.9334C36.3431 63.4944 31.5 67.3487 24.9244 68.5147C28.1926 69.4981 31.587 69.9985 35 70C54.3375 70 70 54.3375 70 35C70 25.1716 65.9334 16.2969 59.395 9.93344Z"
            fill="#00496A"
          />
        </svg>
      </template>
    ...
    <div class="player__right">
      <div class="now">
        <p class="now__discript">Сейчас в эфире:</p>
        <div class="now__text">
      ...
      <div class="player__toggle" v-on:click="open = !open">
        <svg
          ...
          v-bind:class="{ 'player__drop-icon--open': open === true }"
        >
...
export default {
  ...
  computed: {
    ...
    history() {
      return this.$store.getters["podcasts/podcastsHistory"];
    },
    file() {
  ...
  methods: {
    ...
    initHowler() {
      ...
      this.howler.on("load", function () {
        ...
        if (
          component.player.wasPlaying == true ||
          component.player.live == false
        ) {
          this.play();
        }
...
.playlist {
  ...
  &__left {
    ...
    scrollbar-color: $red;
    scrollbar-color: $red inherit; /* «цвет ползунка» «цвет полосы скроллбара» */
    scrollbar-width: 4px;
    @include r(1100) {
      display: none;
    }
